...
```
docker build -t helidon-creditscore-se .
```

## Start the application with Docker

```
docker run --rm -p 8080:8080 helidon-creditscore-se:latest
```
...
kubectl get service helidon-creditscore-se  # Get service info
```
...
```
docker build -t helidon-creditscore-se-native -f Dockerfile.native .
```

Start the application:

```
docker run --rm -p 8080:8080 helidon-creditscore-se-native:latest
```